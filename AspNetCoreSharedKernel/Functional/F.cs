...
public static partial class F
{
    ...
    public static Func<T, IEnumerable<T>> SingletonList<T>() => (item) => [item];
    ...
    public static IDictionary<K, T> Map<K, T>(params KeyValuePair<K, T>[] pairs) where K : notnull
    {
    ...
    // Using
    public static R Using<TDisposable, R>(TDisposable disposable, Func<TDisposable, R> func)
    ...
    public static Unit Using<TDisposable>(TDisposable disposable, Action<TDisposable> act)
        where TDisposable : IDisposable
        => Using(disposable, act.ToFunc());

    public static R Using<TDisposable, R>(Func<TDisposable> createDisposable, Func<TDisposable, R> func)
        where TDisposable : IDisposable
    {
    ...
    public static Unit Using<TDisposable>(Func<TDisposable> createDisposable, Action<TDisposable> action)
        where TDisposable : IDisposable
